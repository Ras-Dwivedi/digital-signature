 ...
 * This class extends the CreateSignatureBaseDsc
 */
public class CreateVisibleSignatureMemDsc extends CreateSignatureBaseDsc
{
     ...
     * @throws IOException
     */
    public Calendar signPDF(InputStream inputStream, OutputStream signedStream, String tsaUrl, String signatureFieldName, String pdfType) throws IOException
    {
        setTsaUrl(tsaUrl);
