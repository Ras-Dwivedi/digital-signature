...
//    public String imageName;
    ...
    public Calendar sign(InputStream is, OutputStream os, String pdfType) throws KeyStoreException, CertificateException, IOException, NoSuchAlgorithmException, UnrecoverableKeyException {
...
//        signing.setImageBytes(readBytes(imageResource));
        ...
        return signing.signPDF(is, os, tsaUrl, "Signature1", pdfType);
        }
         ...
         */
    public Calendar sign(InputStream is, OutputStream os, String password, String pdfType) throws KeyStoreException, CertificateException, IOException, NoSuchAlgorithmException, UnrecoverableKeyException {
